...
- Homepage: four focused sections—hero, linked client strip, three client website previews plus Tate’s TV software and final CTA. The homepage service explorer was removed at Tate’s request; the dedicated Services page retains the full offering. Full reviews, process, pricing and the inquiry form have dedicated routes.
