...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="container-premium relative z-10 flex min-h-[calc(100vh-96px)] items-center justify-center py-16 text-center md:min-h-[760px] md:py-24">
        <Reveal>
          <div className="mx-auto max-w-6xl">
            ...
            <h1 className="mx-auto mt-7 max-w-6xl text-5xl font-black leading-[0.9] tracking-[-0.07em] md:text-7xl xl:text-7xl">
              Technology That
              <br />
              Builds Trust &
              <br />
